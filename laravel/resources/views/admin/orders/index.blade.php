                ...
                <table class="table table-bordered table-striped" id="example1">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="btn-group">
                          <a href="{{ url('/admin/orders/'.$order->id) }}" title="View" data-toggle="tooltip" class="btn btn-sm btn-primary"><i class="fa fa-eye"></i></a>
                          <a href="#" title="Cancel" data-toggle="tooltip" class="btn btn-danger btn-sm" onclick="if(confirm('Are you sure?')) location.href='{{ url('/admin/orders/cancel/'.$order->id.'') }}'"><i class="fa fa-times"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
