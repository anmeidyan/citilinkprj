        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 box box-solid">
                <div class="col-md-6 col-sm-6">
                    <form class="form-horizontal" action="{{ url('admin/sliders/'.$sliders->id)}}" method="post">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <img src="<?php echo nl2br($sliders->image)?>" id="previmg" class="img-responsive" style="max-width:500px;max-height:500px;"/><br/>
                                    <input type="hidden" name="image" class="form-control" id="img" value="{{ $sliders->image }}">
                                </div>
                            </div>
                            <div class="form-group">
